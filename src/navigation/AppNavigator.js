...
import Terapias from "../screens/Terapias";
...
// Better put your these secret keys in .env file loginYouBetter
...
const Main = () => {
  return (
    ...
    >
      ...
      <MainStack.Screen name="Medicamentos" component={Medicamentos}/>
      <MainStack.Screen name="Consultas" component={Consultas}/>
      <MainStack.Screen name="Terapias" component={Terapias}/>
